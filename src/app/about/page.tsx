        ...
        <Wrapper>
            <section className="bg-[#074643]  h-full  text-white text-center">
                <div className="text-center space-y-4">
                    ...
                    <h3 className="text-lg font-semibold sm:text-xl md:text-2xl lg:text-2xl">My name is Muhammad Abdul Wahid</h3>
                    <h3 className="text-lg font-semibold sm:text-xl md:text-2xl lg:text-2xl">I&apos;m 20 years old</h3>
